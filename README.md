...
2. Make your change and run both gates:
   ...
   ```
3. Sign off your commits (`git commit -s`) — this project uses the [DCO](https://developercertificate.org/) rather than a CLA, and CI checks it on every PR. See [CONTRIBUTING.md](CONTRIBUTING.md#sign-off-dco).
